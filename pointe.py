...
from shapenet import PROMPTS, TARGET_LATENTS
...
class PointE(pl.LightningModule):
    ...
    def _init_val_data(self, val_data_loader):
        ...
        for batch in val_data_loader:
            for prompt, target_latent in zip(batch[PROMPTS], batch[TARGET_LATENTS]):
                log_data[TARGET].append(self._plot([target_latent], prompt))
    ...
    def training_step(self, batch, batch_idx):
        prompts, target_latents = (batch[PROMPTS], batch[TARGET_LATENTS])
