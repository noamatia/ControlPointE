...
def parse_evaluate_changeit3d_arguments(notebook_options=None, save_args=True):
    ...
    parser.add_argument('-latent_codes_file', type=str, help='shape_uid_to_latent_code dictionary', default="/scratch/noam/changeit3d/pretrained/shape_latents/pcae_latent_codes.pkl")    
    parser.add_argument('-pretrained_changeit3d', type=str, help='string pointing to saved file', default="/scratch/noam/changeit3d/pretrained/changers/pcae_based/all_shapetalk_classes/decoupling_mag_direction/idpen_0.01_sc_False/best_model.pt")    
    parser.add_argument('-top_pc_dir', type=str, help='top dir location of gt pointclouds', default="/scratch/noam/shapetalk/point_clouds/scaled_to_align_rendering")
    ...
    parser.add_argument('--pretrained_shape_classifier', type=str, help='if given, will be used to measure '
                                                                        'the Class-Preservation (CP) score.', default="/scratch/noam/changeit3d/pretrained/pc_classifiers/rs_2022/all_shapetalk_classes/best_model.pkl")    
    ...
    parser.add_argument('--pretrained_oracle_listener', type=str, help='if given, will be used to measure '
                                                                       'the Linguistic-Association Boost (LAB) score', default="/scratch/noam/changeit3d/pretrained/listeners/oracle_listener/all_shapetalk_classes/rs_2023/listener_dgcnn_based/ablation1/best_model.pkl")
