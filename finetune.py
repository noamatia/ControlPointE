...
def parse_args():
    ...
    parser.add_argument("--val_data", type=str, default="chair_armrests/val")
...
def main(args):
    ...
    if args.val_data:
        ...
        val_dataset = train_dataset.copy(args.num_val_samples)
    val_data_loader = DataLoader(
        dataset=val_dataset, batch_size=len(val_dataset), shuffle=False
    )
    model = ControlPointE(
        lr=args.lr,
        dev=device,
